...
def main():
    ...
    metrics.report_confusion_matrix('test_hmm')  # 打印混淆矩阵
    ...
    metrics.report_confusion_matrix('test_crf')
    ...
    metrics.report_scores()
    metrics.report_confusion_matrix('test_bilstm')
    ...
    metrics.report_scores()
    metrics.report_confusion_matrix('test_bilstm_crf')
